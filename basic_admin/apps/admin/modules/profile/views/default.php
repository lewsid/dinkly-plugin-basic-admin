<div class="container mt-4 mb-4">
	...
	<form role="form" action="/admin/profile/"  method="post" id="site-form">
								...
								<div class="row">
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<div class="radio">
												<label>
													<input type="radio" name="time-format" class="time-format" value="24" <?php echo ($user->getTimeFormat() == "H:i" || $user->getTimeFormat() == "H:i:s") ? 'checked="checked"' : ''; ?>> 24 hour
												</label>
											</div>
										</div>
									</div>
		...
		<div class="row">
			<div class="col-md-12">
				<hr>
				<button type="submit" class="btn btn-primary btn-save-account float-right">Update Profile</button>
